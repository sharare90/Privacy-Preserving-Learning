...
import settings
from settings import NUMBER_OF_ACTIVITIES, NUMBER_OF_HOURS, NUMBER_OF_DAYS, USE_TIME, USE_DAY, \
...
def get_dataset_from_file(number):
    if settings.MAPPED:
        dataset_address = '/home/sharare/PycharmProjects/FederatedLearning_Caching/datasets/adls/mapped/'
    else:
        dataset_address = '/home/sharare/PycharmProjects/FederatedLearning_Caching/datasets/adls/mapped/'
...
if __name__ == '__main__':
    dataset = Dataset('/home/sharare/PycharmProjects/FederatedLearning_Caching/datasets/adls/mapped/1.csv')
    activites = dataset.get_not_repeated_activity_data()
