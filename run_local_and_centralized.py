...
def run_not_local():
    ...
    for current_days in range(3, 34):
    ...
    os.makedirs('./results/not_local_30_homes_results/', exist_ok=True)
    np.savetxt("./results/not_local_30_homes_results/eva_losses.txt", losses, delimiter=',')
    np.savetxt("./results/not_local_30_homes_results/eva_accuracies.txt", accuracies, delimiter=',')
    np.savetxt("./results/not_local_30_homes_results/eva_my_accuracies.txt", my_accuracies, delimiter=',')
